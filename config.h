...
static const char *fonts[] = {"BlexMonoNerdFont:size=10"};
static const char dmenufont[] = "BlexMonoNerdFont:size=10";
...
static const char col_light[] = "#F1A5AD";
static const char *colors[][3] = {
    /*               fg         bg         border   */
    [SchemeNorm] = {col_light, col_light, col_light},
...
static const char *dmenucmd[] = {
    ...
    col_gray1,   "-nf", col_light_purple, "-sb", col_dark_purple, "-sf",
    col_gray4,   NULL};
...
static const char *increase_volume[] = {"pulsemixer", "--change-volume", "+10",
                                        NULL};
static const char *decrease_volume[] = {"pulsemixer", "--change-volume", "-10",
                                        NULL};
