...
static const char *fonts[]          = { "BlexMonoNerdFont-Thin:size=10" };
static const char dmenufont[]       = "BlexMonoNerdFont-Thin:size=10";
...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_light_purple, col_gray1, col_dark_purple},
